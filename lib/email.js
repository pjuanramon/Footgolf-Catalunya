            ...
            html: `
                <div style="font-family: 'Outfit', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background: #ffffff; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 16px 16px;">
                        ...
                        <p style="color: #64748b; font-size: 14px;">Las inscripciones se cerrarán el miércoles anterior a la etapa a las 18:00.</p>
                    </div>
                </div>
            `
        });
        ...
        await resend.emails.send({
            ...
            html: `
                <div style="font-family: 'Outfit', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background: #ffffff; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 16px 16px;">
                        <p>Las inscripciones para la <strong>${etapa.nombre}</strong> cierran <strong>mañana miércoles a las 18:00</strong>.</p>
